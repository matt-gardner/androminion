...
OnStartGameListener {
    ...
    public void onClickJoinGame(View view) {
        // We first allow the user to specify their name, host, and port, while getting default
        // values for these from the preferences.  Then we start the GameActivity with the right
        // extras so that it will join a remote game, instead of starting a local one.
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
